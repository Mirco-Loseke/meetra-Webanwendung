...
(function () {
    ...
    function createMachineCard(machine) {
        ...
        const orderNumberTag = (isInWorkshop && machine.workshop_order_number) ? `
            <div style="position: absolute; top: -18px; left: 10px; height: 36px; padding: 0 16px; background: ${workshopColor}e6; color: #ffffff; border-radius: 20px; font-size: 0.85rem; font-weight: 800; box-shadow: 0 4px 14px rgba(245, 158, 11, 0.4); border: 2px solid rgba(255, 220, 100, 0.6); backdrop-filter: blur(12px); z-index: 10; letter-spacing: 0.5px; display: flex; align-items: center; justify-content: center; gap: 8px;">
