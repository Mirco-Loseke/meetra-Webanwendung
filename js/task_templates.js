...
(function () {
    ...
    window.addSupergroupTemplate = async function () {
        ...
        try {
            ...
            window.showToast('Fehler beim Hinzufügen: ' + err.message);
        }
    };
    ...
    window.moveSupergroupTemplate = async function (id, direction) {
        ...
        try {
            ...
            window.showToast('Fehler beim Verschieben: ' + err.message);
        }
    };
    ...
    window.saveQuickTemplate = async function() {
        ...
        if (!name) return window.showToast('Bitte einen Namen für die Vorlage eingeben.');
        ...
        if (structure.length === 0) return window.showToast('Bitte mindestens eine Gruppe mit Unteraufgaben anlegen.');
        ...
        try {
            ...
            window.resetQTBuilder();
            window.closeQTModal();
            window.showToast('Schnellvorlage erfolgreich gespeichert!');
        } catch (err) {
                ...
                groupDiv.innerHTML = `
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                        ...
                        <div style="position: relative; flex-shrink: 0;">
                            ...
                            <div id="snippet-dropdown-${gIdx}" class="snippet-dropdown hidden" style="position: absolute; bottom: 100%; right: 0; min-width: 250px; max-height: 250px; overflow-y: auto; z-index: 1000; margin-bottom: 12px;">
